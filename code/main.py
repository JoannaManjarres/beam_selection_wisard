...
def preprocess(flag_pre_process, num_antennas_tx, num_antennas_rx, antenna_config):
...
def beam_selection(antenna_config, type_of_connection, type_of_input):
